...
pipeline {
    ...
    environment {
		AZURE_CREDENTIALS_ID = "dsp-jenkins-appdev"
    }

    // Parameters
    parameters {
		choice(choices: ['npd_shared','npd_dev','npd_dev_app','npd_dev_post_provision'], description: 'Environment', name: 'ENVIRONMENT')
    ...
    stages {
      stage('Initialize Runtime') {
        steps {
          ...
          withCredentials([azureServicePrincipal('dsp-jenkins-appdev')]) {
            sh('''
              ...
              mkdir -p /home/agentadmin/helm3
              cd /home/agentadmin/helm3
              curl -o helm3.tgz https://get.helm.sh/helm-v3.3.1-linux-amd64.tar.gz
              tar -zxvf helm3.tgz
