...
variable "fhr_geo_redundant_backup" {
  type        = string
  description = "Enable Geo-redundant or not for server backup. Valid values for this property are Enabled or Disabled, not supported for the basic tier."
}

variable "fhr_auto_grow_enabled" {
  type        = bool
...
variable "fhr_infrastructure_encryption_enabled" {
  type        = bool
...
variable "fhr_private_endpoint_connection_enabled" {
  type        = bool
...
variable "fhr_mysql_admin_azure_ad_user" {
  type        = string
