...
network_contributor_group=$( keylookup "network_contributor_group" )
...
echo "Adding AKS SPN to Network Contributor Group"
az ad group member add --group $network_contributor_group --member-id 9e08ab7c-ef49-4dd1-a0b4-93986d2737dc
