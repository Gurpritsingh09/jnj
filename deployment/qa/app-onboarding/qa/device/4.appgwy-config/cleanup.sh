...
# public DNS parameters; unused for now, records should be created upon request
# public_dns_zone_name="sbx-dvc.use.thesurgicalnet.com"
# public_dns_zone_rg="dvc-na-ds-npd-nwk-sh"
# firewall_public_ip="40.127.150.27"
# public_dns_function_domain_suffix="fun"

# access restrictions parameters
dsp_address_range="10.190.0.0/16"
appgw_public_ip="20.81.127.102"     // proper value needed
