  ...
  "appgw1" = {
    ...
    backend_http_settings = [
      ...
      #},
      {
        ...
        host_name             = "api.data-qa-validation.qa.thesurgicalnet.io"
      }
    ]
    http_listeners = [
      #{
    ...
    probes = [
      ...
      #  name                = "sysdig"
      #  path                = "/"
      #  host                = "sysdig.qa.thesurgicalnet.io"
      #  interval            = "30"
      #  timeout             = "30"
      ...
      #},
      {
        name                = "QA_Validation_Multi"
        path                = "/"
        host                = "api.data-qa-validation.qa.thesurgicalnet.io"
        interval            = "30"
        timeout             = "30"
  ...
  "waf1" = {
    ...
    custom_rules = [{
      ...
      match_conditions = [{
        ...
        match_values       = ["10.185.0.0/16", "172.22.0.0/16"]
      }]
    }]
    policy_settings = {
      enabled = true
