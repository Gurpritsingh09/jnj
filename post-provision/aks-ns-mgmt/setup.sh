...
do
  ...
  #azure_ad_namespace_admin_group=`echo "DS-NPD-AppTeam-$team_name" | tr [a-z] [A-Z]`
  azure_ad_namespace_admin_group=`echo "$ad_grp_prefix-$team_prefix-$app_name" | tr [a-z] [A-Z]`
