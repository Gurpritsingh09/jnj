...
# - Key Vault Access Policy. Grant the current user Access to the Key Vault
...
resource "azurerm_key_vault_access_policy" "this" {
  ...
  key_vault_id = azurerm_key_vault.this.id
  tenant_id    = data.azurerm_client_config.current.tenant_id
  object_id    = "647a4cec-45a1-48c6-a91b-cd8a9bfd83a1"
...
# Key Vault Diagnostic Logging - Storage Account
